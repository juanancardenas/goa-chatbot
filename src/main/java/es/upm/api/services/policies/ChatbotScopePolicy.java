package es.upm.api.services.policies;

import es.upm.api.data.entities.ConversationEntity;
import es.upm.api.data.enums.ChatbotScopeViolationReason;
...
public class ChatbotScopePolicy {
    ...
    public ChatbotScopeDecision evaluate(ConversationEntity conversation, String message) {
